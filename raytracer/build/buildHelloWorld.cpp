...
// // this->add_lights(new Point(Point3D(-100,100,80), RGBColor(1, 1, 1), 1));
//  this->add_ambient(new Ambient(1, 1, 1, 0.5));
//  // Background color.
//  bg_color = black;
//
//  // Camera and sampler.
...
//  sphere_ptr->set_material(new BlinnPhong(red));
...
//  triangle_ptr->set_material(new Matte(blue));
//  add_geometry(triangle_ptr);
//
//  // plane
//  Plane* plane_ptr = new Plane(Point3D(0,1,0), Vector3D(0, 10, 2));
//  plane_ptr->set_material(new Matte(green));  // green
